...
/**
 * list_to_strings - fun--ction that returns an array
 ...
 * @c: the next character af--ter prefix to match
 *
...
/**
 * get_node_index - function t--hat gets the index of a node
